...
fprintf('\n Experiment Left stochastic decomposition with r=3, m=100\n')
...
solvers = {LSD_PNK, ...
           ...
           'tol_linesearch', 1e-9, ...
           'linesearch_optimizer', 'regNewton', ...
           'Newton_damping_factor', 0.1, ...
           'max_abs_t', 100))};
writeout = true;
...
% 1 
disp('1/2')
problem_data = struct( 'system_size', struct('r', 3, 'm', 100), ...                        
...
experiment_fig2 = experiment( @left_stochastic_decomposition, ...
                              ...
                              1/problem_data.system_size.m * ones(1, problem_data.system_size.m), ...
                              struct( ...
                              'random_seed_for_problem', struct('start',5,'increment',0)) );
