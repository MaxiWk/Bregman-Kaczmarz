...
fprintf('\n Experiment Linear equations with uniformly distributed coefficients on probability simplex\n')
...
experiment_fig11 = experiment( @linear_equations_on_probability_simplex, ...
                              ...
                              solvers, ...
                              num_examples, ...
                              iteration_stopping(struct('iter_save', iter_save_fig11, 'maxiter', maxiter_fig11)), ...
                              {'residual'}, ...
...
% 2
disp('2/4')
problem_data.A_distr = struct('type', 'uniform', 'min_A', 0.9, 'max_A', 1);
...
% 3
disp('3/4')
problem_data.A_distr = struct('type', 'uniform', 'min_A', 0, 'max_A', 1);
experiment_fig21 = experiment( @linear_equations_on_probability_simplex, ...
                              problem_data, ...
                              solvers, ...
                              num_examples, ...
                              runtime_stopping(struct('iter_save', iter_save_fig11, 'max_time', 2)), ...
                              {'residual'}, ...
                              1/problem_data.system_size.n * ones(1, problem_data.system_size.n), ...
                              struct( ...
                              'random_seed_for_problem', struct('start',0,'increment',1), ...
...
figure
subplot(2,2,1);
line_plots = plot_minmax_median_quantiles(stats_fig11.residual, solvers, ...
...
subplot(2,2,2);
line_plots = plot_minmax_median_quantiles(stats_fig12.residual, solvers, ...
                                          1:iter_save_fig11:maxiter_fig11);                                                            
...
subplot(2,2,3);
line_plots = plot_minmax_median_quantiles(stats_fig21.residual, solvers, ...
...
subplot(2,2,4);
line_plots = plot_minmax_median_quantiles(stats_fig22.residual, solvers, ...
...
if writeout
    writeout_data_over_array_on_xaxis(... 
          '../../linear_equations_on_simplex/uniform/fig11.txt', ...
     ...
     writeout_data_over_array_on_xaxis(... 
          '../../linear_equations_on_simplex/uniform/fig12.txt', ...
          {'t','POCSmin','rNBKmin','NBKmin', 'POCSmax','rNBKmax','NBKmax', ...
               'POCSmedian','rNBKmedian','NBKmedian', ...
               'POCSquant25','rNBKquant25','NBKquant25', ...
               'POCSquant75','rNBKquant75','NBKquant75'}, ...
    ...
    writeout_data_over_array_on_xaxis(... 
          '../../linear_equations_on_simplex/uniform/fig21.txt', ...
          {'t','POCSmin','rNBKmin','NBKmin', 'POCSmax','rNBKmax','NBKmax', ...
               'POCSmedian','rNBKmedian','NBKmedian', ...
               'POCSquant25','rNBKquant25','NBKquant25', ...
               'POCSquant75','rNBKquant75','NBKquant75'}, ...
    ...
    writeout_data_over_array_on_xaxis(... 
          '../../linear_equations_on_simplex/uniform/fig22.txt', ...
          {'t','POCSmin','rNBKmin','NBKmin', 'POCSmax','rNBKmax','NBKmax', ...
               'POCSmedian','rNBKmedian','NBKmedian', ...
               'POCSquant25','rNBKquant25','NBKquant25', ...
               'POCSquant75','rNBKquant75','NBKquant75'}, ...
